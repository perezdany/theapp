                ...
                <form wire:submit="Add">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                            <input type="text" class="form-control"  maxlength="150" wire:model="nom" required />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                            <input type="text" class="form-control" maxlength="60" wire:model="adresse" 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                            <input type="text" class="form-control" maxlength="150" wire:model="telephone" placeholder="+225 0154795240"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                            <input type="text" class="form-control" maxlength="80" wire:model="activite"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                            <input type="email" class="form-control" maxlength="30" wire:model="adresse_email" 
                            required  />
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                            <input type="text" class="form-control" maxlength="60" wire:model="adresse_facturation" 
                            required  />
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                            <input type="text" class="form-control" maxlength="150" wire:model="numero_contribuable" 
                            required  />
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control" wire:model="id_statutclient" required>
