            ...
            <div class="card card-info card-outline mb-4">
                ...
                <form wire:submit="updateArticle">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                        <input type="text" class="form-control" maxlength="160" id="inputPassword3" wire:model="editArticle.designation" required />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                        <input type="text" class="form-control" maxlength="160" wire:model="editArticle.code" 
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                        <input type="number" class="form-control" maxlength="10" wire:model="editArticle.prix_unitaire" 
                        required onkeyup='this.value=this.value.toUpperCase()' />
                        </div>
                    </div>
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                        <select class="form-control" maxlength="10" wire:model="editArticle.id_typearticle" >
                            @php
