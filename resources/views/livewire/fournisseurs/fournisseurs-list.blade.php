...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="card">
            ...
            <div class="card-header"><h3 class="card-title">Liste des fournisseurs</h3><br>
            
              <button class="btn btn-primary" wire:click="addmodal" >
                <b><i class="fa fa-plus"></i></b></button><br>
              
                <a href="fournisseurs" style="color:blue"><u>Rétablir<i class="fa fa-retweet" aria-hidden="true"></i></u></a> &emsp;&emsp; <label>Filtrer par:</label>
                <div class="row">
                    Date de création:
                    <div class="col-xs-2">
                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="modal fade" id="delete{{$fournisseur->id}}"  wire:ignore.self  role="dialog" aria-hidden="true" >
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="post" action="deletefournisseur">
                                                    <!--begin::Body-->
                                                    @csrf
                                                    <label style="text-align:center; color:red">Voulez vous vraiment supprimer ce fournisseur?</label>
                                                    <input type="text" class="form-control" value="{{$fournisseur->id}}" wire-model="id" 
                                                    name="id" id="{{$fournisseur->id}}" style="display:none;">
