            ...
            <div class="card card-warning">
                ...
                <div class="card-body">
                    <form method="post" action="add_line_devis">
                            ...
                            @if(isset($get_service))
                                ...
                                @if($service->service_id == 8)
                                    <div class="col-sm-6">
                                        ...
                                        <!-- text input -->
                                        <input type="test" value="{{$service->id}}" name="service{{$service->id}}" style="display:none;"> 
                                ...
                                @else
                                    <div class="col-sm-6">
                                        ...
                                        <input type="date" name="prix_ht{{$service->service_id}}" class="form-control" placeholder="Enter ..." required>
                                        </div>
                        ...
                        <a href="devis"><button type="submit" class="btn btn-danger">Retour</button></a>
